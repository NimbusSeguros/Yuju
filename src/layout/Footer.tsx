      ...
      <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-4 gap-12 relative z-10">
        ...
        <div>
          ...
          <ul className="space-y-4 text-text-secondary text-sm font-medium">
            ...
            <li><a href="#" className="hover:text-yuju-blue transition-colors">Preguntas Frecuentes</a></li>
            <li><a href="#" className="hover:text-yuju-blue transition-colors">Contacto</a></li>
          </ul>
        </div>
          ...
          <ul className="space-y-5 text-text-secondary text-sm">
            <li className="flex items-center gap-4">
              ...
              <div className="flex flex-col">
                <span className="text-[10px] uppercase font-bold text-text-secondary/50">Email</span>
                <span className="font-semibold">hola@yuju.com.ar</span>
              </div>
            </li>
            <li className="flex items-center gap-4">
              <div className="w-10 h-10 rounded-xl bg-yuju-blue/10 flex items-center justify-center text-yuju-blue shrink-0">
              ...
              <div className="flex flex-col">
                <span className="text-[10px] uppercase font-bold text-text-secondary/50">Llámanos</span>
                <span className="font-semibold">0800-YUJU-911</span>
              </div>
            </li>
          </ul>
        </div>
